# Packt workshop — operator docs

These docs are for the people who **maintain** the Packt workshop: the folks who'll extend a scenario, debug a stack mid-session, hand the workshop off to a colleague, or fork it into a different event.
...
- [`repo-layout.md`](repo-layout.md) — what every directory under `workshops/packt/` contributes and which docs cover it.
