...
- Stack up: `nobs packt up`, then wait for `nobs packt status` to show 7/7 ok.
- Infrahub seeded: `nobs packt load-infrahub`.
...
nobs packt preflight --skip-c

# Override output dir
nobs packt preflight --out-dir /tmp/my-preflight
```
