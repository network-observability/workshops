...
| 3 | [Alert response, Automation and AI](part-3-alerts-automation-ai.md) | 60–75 min · hands-on | A real alert fires. Walk the cycle, flip one intended-state flag and reach the opposite decision, toggle the root-cause summary, and decide what you'd trust it on |
