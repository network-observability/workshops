"""`nobs packt rca [DEVICE] [PEER]` — print the most recent AI RCA narrative.
...
def rca(
    ...
    if not lines:
        ...
        note(
            ...
            "If you haven't enabled it yet, set ENABLE_AI_RCA=true in workshops/packt/.env "
            "and re-run `nobs packt up`."
        )
        return
